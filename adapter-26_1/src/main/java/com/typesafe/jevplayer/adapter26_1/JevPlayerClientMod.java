package com.typesafe.jevplayer.adapter26_1;
...
public class JevPlayerClientMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        instance = this;
        LOGGER.info("[{}] Initialized client adapter for Minecraft 26.1 (Core v{})",
        ...
        try {
            ...
            LOGGER.info("[{}] Baritone v1.18.0 configured successfully for 26.1!", JevPlayerCore.MOD_NAME);
        } catch (Throwable t) {
