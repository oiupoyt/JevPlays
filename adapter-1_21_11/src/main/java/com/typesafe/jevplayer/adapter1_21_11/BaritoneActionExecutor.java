...
public final class BaritoneActionExecutor implements ActionExecutorBridge {
    ...
    public BaritoneActionExecutor(MinecraftClient client, boolean fairMode) {
        this.client = client;
            ...
            switch (actionId) {
                ...
                case "flee" -> {
                    ...
                    if (player != null) {
                        ...
                        if (!hostiles.isEmpty()) {
                            // Run in opposite direction of nearest threat
                            EntitySummary threat = hostiles.get(0);
                            double angle = Math.toRadians(player.getYaw() + 180.0);
